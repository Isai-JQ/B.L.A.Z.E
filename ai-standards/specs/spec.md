...
## Dudas abiertas
Ninguna por el momento. Todas las dudas de la primera versión (desempate, organizaciones, desconexión a mitad de impresión, cola llena, alcance del rol admin) quedaron resueltas arriba.# Spec 001 — Plataforma Web B.L.A.Z.E v2 (Dashboard + Cola de Prioridad)
